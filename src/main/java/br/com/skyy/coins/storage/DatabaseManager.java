...
public class DatabaseManager {
    ...
    // ── Classe auxiliar para batch save ────────────────────────────────────
    public static final class PlayerSnapshot {
        public final UUID    uuid;
        public final String  name;
        public final long    coins;
        public final boolean toggleReceive;
        public final long    lastTransfer;

        public PlayerSnapshot(UUID uuid, String name, long coins, boolean toggleReceive, long lastTransfer) {
            this.uuid          = uuid;
            this.name          = name;
            this.coins         = coins;
