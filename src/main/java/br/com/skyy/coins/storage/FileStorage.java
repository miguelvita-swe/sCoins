package br.com.skyy.coins.storage;
...
public class FileStorage {
    ...
    public FileStorage(JavaPlugin plugin,
        ...
        // general.top-delay em segundos → converte para ms para o cache TTL
        long topDelaySeconds = mainConfig.getLong("general.top-delay",
                mainConfig.getLong("top-delay", 60L));
        this.TOP_CACHE_TTL = topDelaySeconds * 1_000L;
    ...
    // TTL lido do config: general.top-delay (segundos) → ms. Padrão 60s.
    private final long TOP_CACHE_TTL;
